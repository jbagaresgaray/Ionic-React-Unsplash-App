...
export const collectionsSelectors = {
  ...
  collectionPhotos: createSelector(
    selectRoot,
    (state) => state.collectionPhotos
  ),
  collectionRelated: createSelector(
    selectRoot,
    (state) => state.collectionRelated
  ),
  isLoadingCollection: createSelector(
    selectRoot,
    (state) => state.isLoadingCollection
  ),
  isLoadingCollections: createSelector(
    selectRoot,
    (state) => state.isLoadingCollections
  ),
  isLoadingCollectionPhotos: createSelector(
    selectRoot,
    (state) => state.isLoadingCollectionPhotos
  ),
  isLoadingCollectionRelated: createSelector(
    selectRoot,
    (state) => state.isLoadingCollectionRelated
  ),
};
